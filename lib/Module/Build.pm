...
options (defined by its valid_properties() method) will throw an exception.
...
All of the above methods are simple get/set accessors (an optional
argument sets the value) to a scalar property of the given
Module::Build object.
